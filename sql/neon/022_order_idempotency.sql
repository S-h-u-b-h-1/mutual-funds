...
--
-- Run: psql "$DATABASE_URL" -f sql/neon/022_order_idempotency.sql
-- Applied to BOTH the production branch and the dedicated "test" branch (br-weathered-star-
-- atigraez) in the same change — see docs/TEST_DATABASE_AND_CI.md's schema-drift note.
