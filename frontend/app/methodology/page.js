...
export default function Methodology() {
  return (
    <>
      ...
      <Footer note={<span>Methodology version 3 · Deterministic research, not investment advice · Data © AMFI / SEBI / acquired AMC factsheets.</span>} />
    </>
  );
}
