    ...
    <>
      ...
      <main className="container-px py-10 sm:py-14">
        ...
        <header className="grid gap-7 border-b border-line pb-9 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-end">
          ...
          <div className="rounded-2xl border border-accent/25 bg-accent/5 p-5"><div className="text-sm font-semibold text-ink">Download the complete methodology</div><p className="mt-2 text-xs leading-5 text-ink-muted">Formulas, fund-type frameworks, NFO treatment, AMC logic, comparison rules and limitations.</p><a href="/mf-pulse-ranking-methodology.pdf" download className="mt-4 inline-flex min-h-11 items-center rounded-xl bg-accent px-4 text-xs font-semibold text-white">Download PDF</a></div>
        </header>
        ...
        <Section eyebrow="08 · Known boundaries" title="Confidence is about evidence—not future certainty.">
      ...
      <Footer note={<span>Methodology version 2 · Deterministic research, not investment advice · Data © AMFI / SEBI / acquired AMC factsheets.</span>} />
    </>
  );
}
