...
const INDUSTRY_EVIDENCE = [
  ...
  { pattern: /metal|mining|oil|gas|power|cement/i, title: "Cyclical operating evidence", metrics: ["Volumes and utilisation", "Realisation", "Input-cost spread", "Cost curve position", "Capacity additions", "Net debt through the cycle"] },
