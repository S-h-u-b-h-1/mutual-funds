          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
            ...
            <div className="md:col-span-4 space-y-5">
              ...
              <div className="rounded-xl border border-line bg-white/[0.01] p-4.5 space-y-2.5 text-[12px]">
                ...
                <div className="flex items-center gap-2">
                  <span className={`h-1.5 w-1.5 rounded-full ${dailyFreshnessDot} ${dailyFreshness === "pos" ? "animate-pulse" : ""}`} />
                  <span className="text-ink-muted">{daily.asOf ? `NAV as of ${daily.asOf} · ${dailyFreshnessLabel}` : "NAV date unavailable"}</span>
                </div>
                <div className="flex items-center gap-2">
