...
export default function sitemap() {
  ...
  const pages = ["/performance", "/categories", "/research", "/compare", "/data-quality", "/stocks", "/stocks/universe", "/stocks/screener", "/stocks/sectors", "/stocks/sources", "/markets", "/learn", "/learn/stocks", "/help"].map((p) => ({
    url: `${SITE}${p}`,
    changeFrequency: "daily",
    priority: 0.8,
  }));
