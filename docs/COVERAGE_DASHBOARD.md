# Coverage Dashboard (internal/operational) — 2026-07-16
...
| | |
|---|---:|
| AMFI active schemes (live) | 14,224 |
...
| historical coverage pct | 90.02% |
| returns coverage pct | 99.48% |
| risk coverage pct | 99.57% |
| benchmark coverage pct | 85.92% |
| category coverage pct | 100.0% |
| metadata coverage pct | 1.07% |
| aum coverage pct | 1.07% |
| expense ratio coverage pct | 0.0% |
| manager coverage pct | 0.08% |
