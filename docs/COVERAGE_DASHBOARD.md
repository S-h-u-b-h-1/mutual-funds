# Coverage Dashboard (internal/operational) — 2026-09-06
...
| | |
|---|---:|
| AMFI active schemes (live) | 14,339 |
| MF Pulse schemes | 14,339 |
| Coverage % | 100.0% |
| Missing schemes | 0 |
| **Overall Trust Score** | **79.2/100** |
...
| aum coverage pct | 6.17% |
| expense ratio coverage pct | 1.19% |
| manager coverage pct | 5.38% |
| holdings coverage pct | 1.68% |
| portfolio coverage pct | 0.77% |
