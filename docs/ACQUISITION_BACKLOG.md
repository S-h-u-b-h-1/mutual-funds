...
| P2 | Index-return alpha | 3,458 | medium | index NAV series | benchmark index NAV series not ingested — peer-relative only |
| P2 | Benchmark (all schemes) | 2,003 | medium | SEBI category map | FMP/index/niche categories unmapped |
