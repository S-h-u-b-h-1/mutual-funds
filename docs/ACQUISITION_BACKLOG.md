# Acquisition Backlog — 2026-06-30
...
| P2 | AUM | 14,056 | medium | AMC factsheet PDF / AMFI | only SBI factsheets parsed |
| P2 | Index-return alpha | 3,462 | medium | index NAV series | benchmark index NAV series not ingested — peer-relative only |
