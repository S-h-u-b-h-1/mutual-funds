...
| P1 | Holdings | 14,201 | high | AMC factsheet PDF / monthly portfolio | monthly portfolio disclosures not yet ingested |
...
| P1 | Fund manager | 13,978 | high | AMC factsheet PDF | non-SBI factsheets unparsed; SBI manager field sparse |
| P2 | AUM | 13,834 | medium | AMC factsheet PDF / AMFI | only SBI factsheets parsed |
