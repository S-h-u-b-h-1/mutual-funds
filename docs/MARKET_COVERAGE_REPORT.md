# Market Coverage Report — 2026-09-06
...
| | Count |
|---|---:|
| **Live AMFI universe** (fetched today, https://portal.amfiindia.com/spages/NAVAll.txt) | **14,339** |
| **MF Pulse universe** | **14,339** |
| **Covered (intersection)** | **14,339** |
| **Coverage %** | **100.0%** |
...
- **Exist (live AMFI):** 14,339 scheme-plan-option codes.
- **We have:** 14,339 (100% of live + 0 delisted).
...
| Structure | Schemes |
|---|---:|
| Open Ended Schemes | 9587 |
| Close Ended Schemes | 4711 |
...
International (name-derived): 177 · Commodity (gold/silver): 212
