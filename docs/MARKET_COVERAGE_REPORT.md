...
| | Count |
|---|---:|
| **Live AMFI universe** (fetched today, https://portal.amfiindia.com/spages/NAVAll.txt) | **14,227** |
| **MF Pulse universe** | **14,224** |
| **Covered (intersection)** | **14,224** |
| **Coverage %** | **99.98%** |
| Missing (in AMFI, not in us) | 3 |
...
today is present (missing = 3), plus 0 recently-delisted schemes
retained as dormant for research lookup.

### How many schemes exist / do we have / are missing / why
- **Exist (live AMFI):** 14,227 scheme-plan-option codes.
- **We have:** 14,224 (100% of live + 0 delisted).
- **Missing:** 3. **Why:** none — we ingest the full AMFI NAV file daily (cron).
